...
public class KbActivityHttpClient extends AbstractKbHttpClient implements IActivityApi {
    ...
    @Override
    public HttpResult<ListHolder<ComponentActivity>> findComponentActivities(Set<UUID> componentIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentActivity>> findOngoingVersionActivities(Set<UUID> componentIds, OffsetDateTime activitySince) {
        Objects.requireNonNull(componentIds, "Component ids must be initialized.");
        Preconditions.checkArgument(!componentIds.isEmpty(), "Component ids must not be empty.");
        Preconditions.checkArgument(componentIds.size() <= ID_LIMIT, "Number of component ids must be less than or equal to " + ID_LIMIT);
        Objects.requireNonNull(activitySince, "Activity since must be initialized.");
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionActivities(Set<UUID> componentVersionIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionLicenseActivities(Set<UUID> componentVersionIds, OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
        Objects.requireNonNull(activitySince, "Activity since must be initialized.");
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionCveVulnerabilityActivities(Set<UUID> componentVersionIds,
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionBdsaVulnerabilityActivities(Set<UUID> componentVersionIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionUpgradeGuidanceActivities(Set<UUID> componentVersionIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantActivities(Set<UUID> componentVariantIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantCveVulnerabilityActivities(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantBdsaVulnerabilityActivities(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantUpgradeGuidanceActivities(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantTransitiveUpgradeGuidanceActivities(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<LicenseActivity>> findLicenseActivities(Set<UUID> licenseIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<LicenseActivity>> findLicenseLicenseTermActivities(Set<UUID> licenseIds, OffsetDateTime activitySince) {
        Objects.requireNonNull(licenseIds, "License ids must be initialized.");
        Preconditions.checkArgument(!licenseIds.isEmpty(), "License ids must not be empty.");
        Preconditions.checkArgument(licenseIds.size() <= ID_LIMIT, "Number of license ids must be less than or equal to " + ID_LIMIT);
        Objects.requireNonNull(activitySince, "Activity since must be initialized.");
    ...
    @Override
    public HttpResult<ListHolder<CveVulnerabilityActivity>> findCveVulnerabilityActivities(Set<String> cveVulnerabilityIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<BdsaVulnerabilityActivity>> findBdsaVulnerabilityActivities(Set<String> bdsaVulnerabilityIds, OffsetDateTime activitySince) {
