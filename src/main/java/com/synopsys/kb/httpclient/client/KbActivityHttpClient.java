...
public class KbActivityHttpClient extends AbstractKbHttpClient implements IActivityApi {
    ...
    @Override
    public HttpResult<ListHolder<ComponentActivity>> findComponentActivitiesV3(Set<UUID> componentIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentActivity>> findOngoingVersionActivitiesV3(Set<UUID> componentIds, OffsetDateTime activitySince) {
        Objects.requireNonNull(componentIds, "Component ids must be initialized.");
        Preconditions.checkArgument(!componentIds.isEmpty(), "Component ids must not be empty.");
        Preconditions.checkArgument(componentIds.size() <= ID_LIMIT, "Number of component ids must be less than or equal to " + ID_LIMIT);
        Objects.requireNonNull(activitySince, "Activity since must be initialized.");
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionActivitiesV3(Set<UUID> componentVersionIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionLicenseActivitiesV3(Set<UUID> componentVersionIds,
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionCveVulnerabilityActivitiesV3(Set<UUID> componentVersionIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionBdsaVulnerabilityActivitiesV3(Set<UUID> componentVersionIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVersionActivity>> findComponentVersionUpgradeGuidanceActivitiesV3(Set<UUID> componentVersionIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVersionIds, "Component version ids must be initialized.");
        Preconditions.checkArgument(!componentVersionIds.isEmpty(), "Component version ids must not be empty.");
        Preconditions.checkArgument(componentVersionIds.size() <= ID_LIMIT, "Number of component version ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantActivitiesV3(Set<UUID> componentVariantIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantCveVulnerabilityActivitiesV3(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantBdsaVulnerabilityActivitiesV3(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantUpgradeGuidanceActivitiesV3(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<ComponentVariantActivity>> findComponentVariantTransitiveUpgradeGuidanceActivitiesV3(Set<UUID> componentVariantIds,
            OffsetDateTime activitySince) {
        Objects.requireNonNull(componentVariantIds, "Component variant ids must be initialized.");
        Preconditions.checkArgument(!componentVariantIds.isEmpty(), "Component variant ids must not be empty.");
        Preconditions.checkArgument(componentVariantIds.size() <= ID_LIMIT, "Number of component variant ids must be less than or equal to " + ID_LIMIT);
    ...
    @Override
    public HttpResult<ListHolder<LicenseActivity>> findLicenseActivitiesV3(Set<UUID> licenseIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<LicenseActivity>> findLicenseLicenseTermActivitiesV3(Set<UUID> licenseIds, OffsetDateTime activitySince) {
        Objects.requireNonNull(licenseIds, "License ids must be initialized.");
        Preconditions.checkArgument(!licenseIds.isEmpty(), "License ids must not be empty.");
        Preconditions.checkArgument(licenseIds.size() <= ID_LIMIT, "Number of license ids must be less than or equal to " + ID_LIMIT);
        Objects.requireNonNull(activitySince, "Activity since must be initialized.");
    ...
    @Override
    public HttpResult<ListHolder<CveVulnerabilityActivity>> findCveVulnerabilityActivitiesV3(Set<String> cveVulnerabilityIds, OffsetDateTime activitySince) {
    ...
    @Override
    public HttpResult<ListHolder<BdsaVulnerabilityActivity>> findBdsaVulnerabilityActivitiesV3(Set<String> bdsaVulnerabilityIds, OffsetDateTime activitySince) {
